...
export const projectsData = [
...

    {
        ...
        category: ['All', 'Html/Css', 'React', 'JavaScript'],
        moreInfo: true,
        excerpt: 'A portfolio website that was built from the ground up with React to highlight some of the projects I have worked on. Have a look and and enjoy.',
...

    {
        ...
        slug: 'show-depot',
        featured: false,
        category: ['All', 'Html/Css', 'NextJs', 'Redux', 'JavaScript'],
        moreInfo: true,
        ...
        reflection: 'Overall, my experience with NextJs was great. With server-side rendering, it made working with the front and back end of the app smoother and more intuitive. I found NextJs to be a great introduction to working with a database when it came to making calls to the database. It was super easy since everything was in one place. In conclusion, I quite enjoyed learning NextJs and plan to utilize the framework in future projects.',
